...
<body>
    ...
    <div class="dashboard-tabs">
        <button name='dataset' value='Softlock Data' class='dashboard-softlock-tab'>Project Status</button>
        <button name='dataset' value='Confirmed Data' class='dashboard-confirm-tab'>Associate</button>
    </div>
