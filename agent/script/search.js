        ...
        tableHTML += `
            <tr id='row${user.UserId}'>
                ...
                <td>
                    ...
                    <button class='search-confirm-btn'  ${user.Status=='confirm'?'Disabled':getcookie("AgentId")!=user.AgentId && user.AgentId!=null?'Disabled':''} data-user-email='${user.UserId}'>Confirm</button>
                </td>
