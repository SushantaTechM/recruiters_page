...
<div class="navbar" style="padding-bottom: 30px;">
        ...
        <div class="nav-links">
            ...
            <div class="skill-dropdown">
                <button class="dashboard-dropbtn tab <?= ($filename=='skill.php')?'active':($filename=='skill_dashboard.php')?'active':'' ?>" onclick="toggleSkillDropdown()">Skill</button>
            ...
            <div class="location-dropdown">
                <button class="dashboard-dropbtn tab <?= ($filename=='add_location.php')?'active':($filename=='view_location.php')?'active':'' ?>" onclick="toggleLocationDropdown()">Location</button>
            ...
            <div class="customer-dropdown">
                <button class="dashboard-dropbtn tab <?= ($filename=='customer_creation.php')?'active':($filename=='customer_view.php')?'active':'' ?>" onclick="toggleCustomerDropdown()">Customer</button>
