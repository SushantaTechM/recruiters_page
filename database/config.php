...
$locationmaster = "CREATE TABLE if NOT EXISTS `recruitmentpage`.`locationmaster` ( `LocationId` INT(20) NOT NULL AUTO_INCREMENT , `LocationName` VARCHAR(20) NOT NULL UNIQUE ,`LocationState` VARCHAR(20) NOT NULL,`LocationHeadName` VARCHAR(50) NOT NULL,`LocationHeadEmail`VARCHAR(50) NOT NULL,`LocationHeadMobile`VARCHAR(15) NOT NULL, PRIMARY KEY (`LocationId`)) ENGINE = InnoDB";
