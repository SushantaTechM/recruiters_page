...
$sql="INSERT INTO `locationmaster` (`LocationId`, `LocationName`) VALUES (NULL, 'New York');
    ...
    --   INSERT INTO `project` (`ProjectId`, `CustomerId`, `StartDate`, `EndDate`, `Location`, `ProjectName`) VALUES (NULL, '1', '2024-07-15', '2024-07-29', '3', 'SBI-Banking');
    --   INSERT INTO `project` (`ProjectId`, `CustomerId`, `StartDate`, `EndDate`, `Location`, `ProjectName`) VALUES (NULL, '2', '2024-07-15', '2024-07-29', '2', 'BORN');
    --   INSERT INTO `project` (`ProjectId`, `CustomerId`, `StartDate`, `EndDate`, `Location`, `ProjectName`) VALUES (NULL, '3', '2024-07-15', '2024-07-29', '1', 'Redbull');
